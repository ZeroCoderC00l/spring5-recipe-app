...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        if (!eachUnitOfMeasure.isPresent() || !cupUnitOfMeasure.isPresent() || !pintUnitOfMeasure.isPresent() ||
            !dashUnitOfMeasure.isPresent() || !teaspoonUnitOfMeasure.isPresent() || !tablespoonUnitOfMeasure.isPresent()){
        ...
        UnitOfMeasure cupsUom = cupUnitOfMeasure.get();
        ...
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the " +
                ...
                "in the lime juice will provide some balance to the richness of the avocado and will help delay the " +
                ...
                "taste because of the variability in the fresh ingredients. Start with this recipe and adjust to " +
                "your taste." +
                "\n" +
        ...
        tacosNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                ...
                "pickled jalapenos. I can always sniff out a late-night snacker when the aroma of tortillas " +
        ...
        tacosRecipe.addIngredient(new Ingredient("skinless, boneless chicken thighs", new BigDecimal(8), eachUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("pint cherry tomatoes, halved", new BigDecimal(.5), pintUom));
